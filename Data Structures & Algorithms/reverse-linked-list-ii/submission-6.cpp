...
public:
    ...
    ListNode* reverseBetween(ListNode* head, int left, int right) {
        ...
        // pointer = &object syntaxt as dummy is an object
        // ListNode dummy; here dummy is object itself
        //     Object instance
        //     Stack object
        //     Automatic storage duration
        // ListNode* dummy = new ListNode; here dummy is a pointer used to store the address newly create heap object
        //     Pointer
